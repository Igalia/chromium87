...
const wl_interface* ObjectTraits<agl_shell_desktop>::interface = &agl_shell_desktop_interface;
void (*ObjectTraits<agl_shell_desktop>::deleter)(agl_shell_desktop*) = &agl_shell_desktop_destroy;
